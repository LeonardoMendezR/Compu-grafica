...
class RaySceneGPU(Scene):
    ...
    def _matrix_to_ssbo(self):
        self.raytracer._matrix_to_ssbo(self.models_f,0)
        self.raytracer._matrix_to_ssbo(self.inv_f,1)
        self.raytracer._matrix_to_ssbo(self.mats_f,2)
        self.raytracer._primitives_to_ssbo(self.primitives,3)