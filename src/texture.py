...
class Texture:
    def __init__(self, name = "u_texture", width=1, height=1, channels_amount=4, image_data:ImageData=None, color=(0,0,0), repeat_x=False, repeat_y=False, build_mipmaps=False):
        self.name = name
